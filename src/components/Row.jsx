...
const Row = ({title, fetchURL, rowID}) => {
  ...
  return (
    <>
      <h2 className='text-white font-bold md:test-xl p-4'>{title}</h2>
      <div className='relative flex items-center group'>
        ...
        <div id={'slider'+rowID} className='width-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
              {movies.map((item,id)=>(
